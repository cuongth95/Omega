...
namespace Omega
{
    public partial class Form1 : Form
    {
        ...
        {
            //InitializeComponent();
            this.ClientSize = new Size(Constants.WINDOW_WIDTH, Constants.WINDOW_HEIGHT);
            this.SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.UserPaint | ControlStyles.OptimizedDoubleBuffer, true);

            // Create the backbuffer
            var backbuffer = new Bitmap(Constants.WINDOW_WIDTH, Constants.WINDOW_HEIGHT);
        ...
        public void ProcessGameLoop()
        {
            ...
            Scene.Width = Constants.WINDOW_WIDTH;
            Scene.Height = Constants.WINDOW_HEIGHT;
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    var deltaTime = (float)(curTime - prevTime) / 1000;
                    if (deltaTime >= FRAME_RATE)
                    {
                        //Console.WriteLine("elapsed time = " + deltaTime);
